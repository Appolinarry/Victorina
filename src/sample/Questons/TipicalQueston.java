...
public class TipicalQueston extends  Victorin{
    ...
    public TipicalQueston(int number,String queston, String answera,String answerb,String answerc, String rightanswer,
                          int count, String nametopic, String fotoname) {
